...
use crate::workload_wire::{
    ...
    write_deployment_policy as write_job_deployment_policy, write_env_vars, write_liveness_probe,
    write_network_requirements, write_placement_policy, write_port_bindings, write_secret_files,
    write_volume_mounts,
};
...
struct PreparedJobSubmitSpec {
    ...
    deployment_policy: JobDeploymentPolicySpec,
...
async fn submit_prepared_job(
    ...
    Ok(JobRunResult {
        ...
        memory_bytes: prepared.execution.memory_bytes,
...
async fn prepare_raw_submit_spec(
    ...
    Ok(PreparedJobSubmitSpec {
        ...
        deployment_policy: JobDeploymentPolicySpec::default(),
