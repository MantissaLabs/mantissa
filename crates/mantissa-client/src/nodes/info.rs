...
fn nodeport_drop_reason_fields(
    reasons: mantissa_protocol::info_capnp::node_port_ingress_drop_reasons::Reader<'_>,
) -> Result<Vec<String>> {
...
fn nodeport_flow_diagnostics_fields(
    diagnostics: mantissa_protocol::info_capnp::node_port_flow_diagnostics::Reader<'_>,
) -> Vec<String> {
...
fn load_balancer_flow_diagnostics_fields(
    diagnostics: mantissa_protocol::info_capnp::load_balancer_flow_diagnostics::Reader<'_>,
) -> Vec<String> {
    let ipv4_pairs = diagnostics.get_ipv4_flow_pairs();
    let ipv6_pairs = diagnostics.get_ipv6_flow_pairs();
    let total_pairs = ipv4_pairs.saturating_add(ipv6_pairs);
