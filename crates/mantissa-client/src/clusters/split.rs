...
impl SplitServicePolicy {
    ...
    fn to_capnp(self) -> mantissa_protocol::topology::SplitServicePolicy {
        match self {
            Self::Partitioned => mantissa_protocol::topology::SplitServicePolicy::Partitioned,
            Self::Preserve => mantissa_protocol::topology::SplitServicePolicy::Preserve,
        }
    }
}
...
impl SplitNetworkPolicy {
    /// Encodes this policy into the topology RPC enum.
    fn to_capnp(self) -> mantissa_protocol::topology::SplitNetworkPolicy {
        match self {
            Self::Isolate => mantissa_protocol::topology::SplitNetworkPolicy::Isolate,
            Self::Preserve => mantissa_protocol::topology::SplitNetworkPolicy::Preserve,
        }
    }
}
