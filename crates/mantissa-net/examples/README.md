...
perf report --stdio --sort symbol -i perf.data | \
  grep -e 'mantissa_net::noise::transport::NoiseWriteHalf::poll_drain_pending_wire' \
       -e 'mantissa_net::noise::transport::NoiseWriteHalf::prepare_pending_frame_from_staged' \
       -e 'mantissa_net::noise::transport::poll_fill_reader' \
