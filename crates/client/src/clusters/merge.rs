...
impl MergeServicePolicy {
    ...
    fn to_capnp(self) -> protocol::topology::MergeServicePolicy {
        match self {
            Self::Rebalance => protocol::topology::MergeServicePolicy::Rebalance,
            Self::Preserve => protocol::topology::MergeServicePolicy::Preserve,
        }
    }
}
