use super::list::{ServiceRolloutPhaseRow, ServiceRolloutRow, ServiceRow, host_ports_summary};
use crate::output;
use anyhow::Result;
use mantissa_client::{config::ClientConfig, services::rollout::classify_rollout_outcome};
...
pub(super) fn rollout_phase_label(phase: ServiceRolloutPhaseRow) -> &'static str {
    match phase {
