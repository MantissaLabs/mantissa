...
pub struct ClusterTransition {
    ...
    pub local_view_node_ids: HashSet<Uuid>,
    ...
    pub fn from_operation(
        ...
        let (
            ...
            ClusterOperationKind::Split => {
                ...
                let local_view_node_ids = operation
                    .split_assignments
                    .iter()
                ...
                let mut out_of_view_node_ids = known_peer_ids
                    .iter()
                    .copied()
                    .filter(|peer_id| !local_view_node_ids.contains(peer_id))
                    .collect::<HashSet<_>>();
                ...
                for assignment in operation.split_assignments.iter() {
                    if assignment.target_index != local_target_index {
                        out_of_view_node_ids.insert(assignment.node_id);
                    }
                }

                (
                    Some(local_target_index),
                    target_view,
                    local_view_node_ids,
        ...
        out_of_view_node_ids.remove(&local_node_id);
