...
#[inline]
pub fn set_node_id(mut id_builder: crate::topology_capnp::node_id::Builder, id: &Uuid) {
    id_builder.set_bytes(&uuid_to_bytes(id));
}

/// Read NodeId (bytes) from a reader and return a Uuid.
#[inline]
pub fn read_node_id(id_reader: crate::topology_capnp::node_id::Reader) -> Result<Uuid, CapnpError> {
