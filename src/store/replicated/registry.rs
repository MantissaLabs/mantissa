...
pub const REPLICATED_DOMAINS: [Domain; 19] = [
    Domain::Peers,
    Domain::Workloads,
    Domain::Services,
    Domain::Jobs,
...
pub fn domain_label(domain: Domain) -> &'static str {
    match domain {
        ...
        Domain::VolumeCapacityRequests => "volume capacity requests",
...
pub fn domain_key(domain: Domain) -> u16 {
    match domain {
        ...
        Domain::VolumeCapacityRequests => 18,
...
pub fn replicated_store_registry(stores: ReplicatedStoreHandles) -> ReplicatedStoreRegistry {
    ReplicatedStoreRegistry::new([
        ...
        ReplicatedStoreEntry::new(
            Domain::VolumeCapacityRequests,
            stores.volume_capacity_requests,
        ),
